# hout - a non-interactive proof assistant for first-order logic, in Haskell [![Hackage](https://img.shields.io/hackage/v/hout)](https://hackage.haskell.org/package/hout)
